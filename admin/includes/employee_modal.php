        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="edit_school" class="col-sm-3 control-label">School/Division</label>
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="school" id="edit_school">
                        ...
                        <?php
                          $esql = "SELECT * FROM school";
                          $equery = $conn->query($esql);
                          while($erow = $equery->fetch_assoc()){
                            echo "
                              <option value='".$erow['id']."'>".$erow['school_name']."</option>
                            ";
                          }
                        ?>
                      </select>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="school" id="edit_school">
                        <option selected id="school_val"></option>
                        <?php
                          $sql = "SELECT * FROM school";
                          $query = $conn->query($sql);
                          while($prow = $query->fetch_assoc()){
                            echo "
                              <option value='".$prow['id']."'>".$prow['school_name']."</option>
                            ";
                          }
                        ?>
                      </select>
