                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      $select_employee = "SELECT * FROM employees WHERE id='$empid'";
                      $select_employeeid = $conn->query($select_employee);
                      $employeeid_ovr = $select_employeeid->fetch_assoc();
                      $id_ovr = $employeeid_ovr['employee_id'];
                      $ovrsql = "SELECT *,SUM(hours) AS ovrhours  FROM overtime WHERE employee_id='$id_ovr' AND date_overtime BETWEEN '$from' AND '$to'";
                      
                      $ovrquery = $conn->query($ovrsql);
                      $ovrrow = $ovrquery->fetch_assoc();
                      $overtime_hours = $ovrrow['ovrhours'];
                      $overtime_rate = $ovrrow['rate'];
                      $ovr_amount = $overtime_hours * $overtime_rate;

                      $gross = $row['rate'] * $row['total_hr'];
                      $gross = $gross + $ovr_amount;
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".number_format($ovr_amount, 2)."</td>
